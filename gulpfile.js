...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/urhack/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
      ...
      plugins: [
        commonjs({
          namedExports: {
            ...
            'node_modules/react-openlayers/dist/react-openlayers.umd.js': ['Component'],
	  }
        }),
        rootImport({
    ...
    .pipe(gulp.dest('./urbit/app/urhack/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/urhack/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/urhack/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/urhack/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/urhack/js/'));
});
